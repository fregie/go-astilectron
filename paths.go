...
func AstilectronDownloadSrc() string {
	return fmt.Sprintf("https://github.com/fregie/astilectron/archive/v%s.zip", VersionAstilectron)
}
...
func ElectronDownloadSrc(os, arch string) string {
	if os == "windows" {
		return "https://s3-ap-northeast-1.amazonaws.com/cache.transocks/download/electron-windows-amd64-v4.0.3.zip"
	}
